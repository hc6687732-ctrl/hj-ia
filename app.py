...
st.markdown('<div class="main-title">⚡ HJ IA</div>', unsafe_allow_headers=True)
st.markdown(
    '<div class="sub-title">A Inteligência Artificial Definitiva: Do Primário à Universidade | Criada por <b>Ernesto Zeferino</b></div>',
    unsafe_allow_headers=True,
)
